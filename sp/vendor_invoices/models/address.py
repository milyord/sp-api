...
class Address:
    ...
    Attributes:
        ...
        address_line_1 (str): First line of street address.
        ...
        state_or_region (Union[Unset, str]): The state or region where person, business or institution is located.
        postal_or_zip_code (Union[Unset, str]): The postal or zip code of that address. It contains a series of letters
    ...
    postal_or_zip_code: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if postal_or_zip_code is not UNSET:
            field_dict["postalOrZipCode"] = postal_or_zip_code
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        postal_or_zip_code = d.pop("postalOrZipCode", UNSET)
