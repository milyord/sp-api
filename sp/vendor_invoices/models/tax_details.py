...
from ..models.tax_details_tax_type import TaxDetailsTaxType
...
class TaxDetails:
    ...
    Attributes:
        tax_type (TaxDetailsTaxType): Type of the tax applied.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        tax_type = TaxDetailsTaxType(d.pop("taxType"))
