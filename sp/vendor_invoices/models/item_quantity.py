...
class ItemQuantity:
    r"""Details of quantity.

    Attributes:
        amount (int): Quantity of an item. This value should not be zero.
        unit_of_measure (ItemQuantityUnitOfMeasure): Unit of measure for the quantity.
        unit_size (Union[Unset, int]): The case size, if the unit of measure value is Cases.
    """
