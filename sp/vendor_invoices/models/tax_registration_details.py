...
class TaxRegistrationDetails:
    ...
    Attributes:
        tax_registration_type (TaxRegistrationDetailsTaxRegistrationType): The tax registration type for the entity.
        tax_registration_number (str): The tax registration number for the entity. For example, VAT ID.
    """
