...
if TYPE_CHECKING:
    from ..models.create_shipment_result import CreateShipmentResult
    from ..models.error import Error


T = TypeVar("T", bound="CreateShipmentResponse")


@attr.s(auto_attribs=True)
class CreateShipmentResponse:
    r"""The response schema for the createShipment operation.

    Attributes:
        payload (Union[Unset, CreateShipmentResult]): The payload schema for the createShipment operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateShipmentResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, CreateShipmentResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = CreateShipmentResult.from_dict(_payload)
