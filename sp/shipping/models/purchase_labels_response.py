...
if TYPE_CHECKING:
    ...
    from ..models.purchase_labels_result import PurchaseLabelsResult


T = TypeVar("T", bound="PurchaseLabelsResponse")


@attr.s(auto_attribs=True)
class PurchaseLabelsResponse:
    r"""The response schema for the purchaseLabels operation.

    Attributes:
        payload (Union[Unset, PurchaseLabelsResult]): The payload schema for the purchaseLabels operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "PurchaseLabelsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, PurchaseLabelsResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = PurchaseLabelsResult.from_dict(_payload)
