...
if TYPE_CHECKING:
    ...
    from ..models.purchase_shipment_result import PurchaseShipmentResult


T = TypeVar("T", bound="PurchaseShipmentResponse")


@attr.s(auto_attribs=True)
class PurchaseShipmentResponse:
    r"""The response schema for the purchaseShipment operation.

    Attributes:
        payload (Union[Unset, PurchaseShipmentResult]): The payload schema for the purchaseShipment operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "PurchaseShipmentResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, PurchaseShipmentResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = PurchaseShipmentResult.from_dict(_payload)
