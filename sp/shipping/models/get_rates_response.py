...
if TYPE_CHECKING:
    ...
    from ..models.get_rates_result import GetRatesResult


T = TypeVar("T", bound="GetRatesResponse")


@attr.s(auto_attribs=True)
class GetRatesResponse:
    r"""The response schema for the getRates operation.

    Attributes:
        payload (Union[Unset, GetRatesResult]): The payload schema for the getRates operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetRatesResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetRatesResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetRatesResult.from_dict(_payload)
