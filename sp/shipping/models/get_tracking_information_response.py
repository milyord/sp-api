...
if TYPE_CHECKING:
    ...
    from ..models.tracking_information import TrackingInformation


T = TypeVar("T", bound="GetTrackingInformationResponse")


@attr.s(auto_attribs=True)
class GetTrackingInformationResponse:
    r"""The response schema for the getTrackingInformation operation.

    Attributes:
        payload (Union[Unset, TrackingInformation]): The payload schema for the getTrackingInformation operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "TrackingInformation"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, TrackingInformation]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = TrackingInformation.from_dict(_payload)
