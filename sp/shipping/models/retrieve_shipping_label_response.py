...
if TYPE_CHECKING:
    ...
    from ..models.retrieve_shipping_label_result import RetrieveShippingLabelResult


T = TypeVar("T", bound="RetrieveShippingLabelResponse")


@attr.s(auto_attribs=True)
class RetrieveShippingLabelResponse:
    r"""The response schema for the retrieveShippingLabel operation.

    Attributes:
        payload (Union[Unset, RetrieveShippingLabelResult]): The payload schema for the retrieveShippingLabel operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "RetrieveShippingLabelResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, RetrieveShippingLabelResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = RetrieveShippingLabelResult.from_dict(_payload)
