...
T = TypeVar("T", bound="GetShipmentResponse")


@attr.s(auto_attribs=True)
class GetShipmentResponse:
    r"""The response schema for the getShipment operation.

    Attributes:
        payload (Union[Unset, Shipment]): The shipment related data.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Shipment"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, Shipment]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = Shipment.from_dict(_payload)
