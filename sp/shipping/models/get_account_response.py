...
class GetAccountResponse:
    r"""The response schema for the getAccount operation.

    Attributes:
        payload (Union[Unset, Account]): The account related data.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Account"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, Account]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = Account.from_dict(_payload)
