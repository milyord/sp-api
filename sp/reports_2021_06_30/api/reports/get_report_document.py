...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorList, ReportDocument]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ReportDocument.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorList, ReportDocument]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[ErrorList, ReportDocument]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[ErrorList, ReportDocument]]:
    """Returns the information required for retrieving a report document's contents.
