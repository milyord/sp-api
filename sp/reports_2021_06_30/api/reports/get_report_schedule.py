...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorList, ReportSchedule]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ReportSchedule.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorList, ReportSchedule]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[ErrorList, ReportSchedule]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[ErrorList, ReportSchedule]]:
    """Returns report schedule details for the report schedule that you specify.
