...
if TYPE_CHECKING:
    ...
    from ..models.shipment_invoice_status_response import ShipmentInvoiceStatusResponse


T = TypeVar("T", bound="GetInvoiceStatusResponse")


@attr.s(auto_attribs=True)
class GetInvoiceStatusResponse:
    r"""The response schema for the getInvoiceStatus operation.

    Attributes:
        payload (Union[Unset, ShipmentInvoiceStatusResponse]): The shipment invoice status response.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ShipmentInvoiceStatusResponse"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ShipmentInvoiceStatusResponse]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ShipmentInvoiceStatusResponse.from_dict(_payload)
