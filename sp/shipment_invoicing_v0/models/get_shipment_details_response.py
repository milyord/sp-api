...
if TYPE_CHECKING:
    ...
    from ..models.shipment_detail import ShipmentDetail


T = TypeVar("T", bound="GetShipmentDetailsResponse")


@attr.s(auto_attribs=True)
class GetShipmentDetailsResponse:
    r"""The response schema for the getShipmentDetails operation.

    Attributes:
        payload (Union[Unset, ShipmentDetail]): The information required by a selling partner to issue a shipment
            invoice.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ShipmentDetail"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ShipmentDetail]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ShipmentDetail.from_dict(_payload)
