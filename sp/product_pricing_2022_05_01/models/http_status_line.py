...
T = TypeVar("T", bound="HttpStatusLine")


@attr.s(auto_attribs=True)
class HttpStatusLine:
    r"""The HTTP status line associated with the response to an individual request within a batch. For more information,
    consult [RFC 2616](https://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html).
