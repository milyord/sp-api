...
if TYPE_CHECKING:
    ...
    from ..models.tax_registration_detail import TaxRegistrationDetail
...
class PartyIdentification:
    ...
    Attributes:
        ...
        tax_registration_details (Union[Unset, List['TaxRegistrationDetail']]): Tax registration details of the entity.
    """

    party_id: str
    address: Union[Unset, "Address"] = UNSET
    tax_registration_details: Union[Unset, List["TaxRegistrationDetail"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tax_registration_details_item_data in _tax_registration_details or []:
            tax_registration_details_item = TaxRegistrationDetail.from_dict(tax_registration_details_item_data)
