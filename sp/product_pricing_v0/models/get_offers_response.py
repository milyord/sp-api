...
if TYPE_CHECKING:
    ...
    from ..models.get_offers_result import GetOffersResult


T = TypeVar("T", bound="GetOffersResponse")


@attr.s(auto_attribs=True)
class GetOffersResponse:
    r"""The response schema for the `getListingOffers` and `getItemOffers` operations.

    Attributes:
        payload (Union[Unset, GetOffersResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetOffersResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetOffersResult.from_dict(_payload)
