...
if TYPE_CHECKING:
    ...
    from ..models.listing_offers_request_params import ListingOffersRequestParams


T = TypeVar("T", bound="ListingOffersResponse")
...
class ListingOffersResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_request, Unset):
            ...
            request = ListingOffersRequestParams.from_dict(_request)
