...
from ...models.get_listing_offers_batch_request import GetListingOffersBatchRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: GetListingOffersBatchRequest,
) -> Dict[str, Any]:
    url = "{}/batches/products/pricing/v0/listingOffers".format(client.base_url)
...
) -> Optional[Union[Errors, GetListingOffersBatchResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetListingOffersBatchResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Errors, GetListingOffersBatchResponse]]:
    return Response(
...
def sync_detailed(
    ...
    **Usage Plan:**
    ...
    Args:
        json_body (GetListingOffersBatchRequest): The request associated with the
            `getListingOffersBatch` API call.
