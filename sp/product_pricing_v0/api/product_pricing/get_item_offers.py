...
from ...models.get_item_offers_customer_type import GetItemOffersCustomerType
from ...models.get_item_offers_item_condition import GetItemOffersItemCondition
...
def _get_kwargs(
    ...
    *,
    client: Client,
    marketplace_id: str,
    item_condition: GetItemOffersItemCondition,
    customer_type: Union[Unset, None, GetItemOffersCustomerType] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/pricing/v0/items/{Asin}/offers".format(client.base_url, Asin=asin)
...
def sync_detailed(
    ...
    **Usage Plan:**
    ...
    Args:
        ...
        marketplace_id (str):
        item_condition (GetItemOffersItemCondition):
        customer_type (Union[Unset, None, GetItemOffersCustomerType]):
