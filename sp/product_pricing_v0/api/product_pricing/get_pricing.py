...
from ...models.get_pricing_item_condition import GetPricingItemCondition
from ...models.get_pricing_item_type import GetPricingItemType
from ...models.get_pricing_offer_type import GetPricingOfferType
...
def _get_kwargs(
    *,
    ...
    item_type: GetPricingItemType,
    item_condition: Union[Unset, None, GetPricingItemCondition] = UNSET,
    offer_type: Union[Unset, None, GetPricingOfferType] = UNSET,
) -> Dict[str, Any]:
    url = "{}/products/pricing/v0/price".format(client.base_url)
    ...
    json_item_condition: Union[Unset, None, str] = UNSET
    if not isinstance(item_condition, Unset):
        json_item_condition = item_condition.value if item_condition else None

    params["ItemCondition"] = json_item_condition

    json_offer_type: Union[Unset, None, str] = UNSET
    if not isinstance(offer_type, Unset):
        json_offer_type = offer_type.value if offer_type else None

    params["OfferType"] = json_offer_type
...
def sync_detailed(
    ...
    **Usage Plan:**
    ...
    Args:
        ...
        item_type (GetPricingItemType):
        item_condition (Union[Unset, None, GetPricingItemCondition]):
        offer_type (Union[Unset, None, GetPricingOfferType]):
