...
if TYPE_CHECKING:
    ...
    from ..models.upload_destination import UploadDestination


T = TypeVar("T", bound="CreateUploadDestinationResponse")


@attr.s(auto_attribs=True)
class CreateUploadDestinationResponse:
    r"""The response schema for the createUploadDestination operation.

    Attributes:
        payload (Union[Unset, UploadDestination]): Information about an upload destination.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "UploadDestination"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, UploadDestination]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = UploadDestination.from_dict(_payload)
