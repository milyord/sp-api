...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/vendor/directFulfillment/shipping/2021-12-28/packingSlips/{purchaseOrderNumber}".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ErrorList, PackingSlip]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PackingSlip.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ErrorList, PackingSlip]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[ErrorList, PackingSlip]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[ErrorList, PackingSlip]]:
    """Returns a packing slip based on the purchaseOrderNumber that you specify.
