...
def _get_kwargs(
    *,
    ...
    url = "{}/vendor/directFulfillment/shipping/2021-12-28/shipmentStatusUpdates".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """This operation is only to be used by Vendor-Own-Carrier (VOC) vendors. Calling this API submits a
