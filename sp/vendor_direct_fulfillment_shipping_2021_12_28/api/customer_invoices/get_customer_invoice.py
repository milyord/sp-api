...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/vendor/directFulfillment/shipping/2021-12-28/customerInvoices/{purchaseOrderNumber}".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CustomerInvoice, ErrorList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CustomerInvoice.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CustomerInvoice, ErrorList]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[CustomerInvoice, ErrorList]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[CustomerInvoice, ErrorList]]:
    """Returns a customer invoice based on the purchaseOrderNumber that you specify.
