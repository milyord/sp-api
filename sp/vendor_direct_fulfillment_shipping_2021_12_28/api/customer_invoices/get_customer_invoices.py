...
from ...models.customer_invoice_list import CustomerInvoiceList
...
def _get_kwargs(
    *,
    ...
    url = "{}/vendor/directFulfillment/shipping/2021-12-28/customerInvoices".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CustomerInvoiceList, ErrorList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CustomerInvoiceList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CustomerInvoiceList, ErrorList]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    sort_order: Union[Unset, None, GetCustomerInvoicesSortOrder] = UNSET,
    next_token: Union[Unset, None, str] = UNSET,
) -> Response[Union[CustomerInvoiceList, ErrorList]]:
...
def sync(
    *,
    ...
    sort_order: Union[Unset, None, GetCustomerInvoicesSortOrder] = UNSET,
    next_token: Union[Unset, None, str] = UNSET,
) -> Optional[Union[CustomerInvoiceList, ErrorList]]:
    """Returns a list of customer invoices created during a time frame that you specify. You define the
    time frame using the createdAfter and createdBefore parameters. You must use both of these
    parameters. The date range to search must be no more than 7 days.
