...
class PackedItem:
    ...
    Attributes:
        ...
        piece_number (Union[Unset, int]): The piece number of the item in this container. This is required when the item
            is split across different containers.
    ...
    piece_number: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if piece_number is not UNSET:
            field_dict["pieceNumber"] = piece_number
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        piece_number = d.pop("pieceNumber", UNSET)
