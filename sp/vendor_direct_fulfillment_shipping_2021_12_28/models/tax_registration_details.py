...
class TaxRegistrationDetails:
    ...
    Attributes:
        ...
        tax_registration_type (Union[Unset, TaxRegistrationDetailsTaxRegistrationType]): Tax registration type for the
            entity.
        tax_registration_address (Union[Unset, Address]): Address of the party.
        tax_registration_messages (Union[Unset, str]): Tax registration message that can be used for additional tax
            related details.
    """

    tax_registration_number: str
    tax_registration_type: Union[Unset, TaxRegistrationDetailsTaxRegistrationType] = UNSET
    tax_registration_address: Union[Unset, "Address"] = UNSET
    tax_registration_messages: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        tax_registration_messages = self.tax_registration_messages
        ...
        if tax_registration_messages is not UNSET:
            field_dict["taxRegistrationMessages"] = tax_registration_messages
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tax_registration_type: Union[Unset, TaxRegistrationDetailsTaxRegistrationType]
        if isinstance(_tax_registration_type, Unset):
            tax_registration_type = UNSET
        else:
            tax_registration_type = TaxRegistrationDetailsTaxRegistrationType(_tax_registration_type)
        ...
        tax_registration_messages = d.pop("taxRegistrationMessages", UNSET)

        result = cls(
            tax_registration_number=tax_registration_number,
            tax_registration_type=tax_registration_type,
            tax_registration_address=tax_registration_address,
            tax_registration_messages=tax_registration_messages,
        )
