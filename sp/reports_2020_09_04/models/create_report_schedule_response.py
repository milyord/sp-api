...
if TYPE_CHECKING:
    from ..models.create_report_schedule_result import CreateReportScheduleResult
    from ..models.error import Error


T = TypeVar("T", bound="CreateReportScheduleResponse")


@attr.s(auto_attribs=True)
class CreateReportScheduleResponse:
    r"""The response for the createReportSchedule operation.

    Attributes:
        payload (Union[Unset, CreateReportScheduleResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateReportScheduleResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CreateReportScheduleResult.from_dict(_payload)
