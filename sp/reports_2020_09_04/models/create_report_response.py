...
if TYPE_CHECKING:
    from ..models.create_report_result import CreateReportResult
...
class CreateReportResponse:
    r"""The response for the createReport operation.

    Attributes:
        payload (Union[Unset, CreateReportResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateReportResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CreateReportResult.from_dict(_payload)
