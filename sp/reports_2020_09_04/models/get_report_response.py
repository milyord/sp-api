...
T = TypeVar("T", bound="GetReportResponse")


@attr.s(auto_attribs=True)
class GetReportResponse:
    r"""The response for the getReport operation.

    Attributes:
        payload (Union[Unset, Report]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Report"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = Report.from_dict(_payload)
