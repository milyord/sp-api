...
T = TypeVar("T", bound="GetReportScheduleResponse")


@attr.s(auto_attribs=True)
class GetReportScheduleResponse:
    r"""The response for the getReportSchedule operation.

    Attributes:
        payload (Union[Unset, ReportSchedule]): Detailed information about a report schedule.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ReportSchedule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ReportSchedule]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ReportSchedule.from_dict(_payload)
