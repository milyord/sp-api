...
T = TypeVar("T", bound="GetReportDocumentResponse")
...
class GetReportDocumentResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ReportDocument.from_dict(_payload)
