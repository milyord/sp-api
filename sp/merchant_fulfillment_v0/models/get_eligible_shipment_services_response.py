...
if TYPE_CHECKING:
    ...
    from ..models.get_eligible_shipment_services_result import GetEligibleShipmentServicesResult


T = TypeVar("T", bound="GetEligibleShipmentServicesResponse")
...
class GetEligibleShipmentServicesResponse:
    ...
    Attributes:
        payload (Union[Unset, GetEligibleShipmentServicesResult]): The payload for the getEligibleShipmentServices
            operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetEligibleShipmentServicesResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetEligibleShipmentServicesResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetEligibleShipmentServicesResult.from_dict(_payload)
