...
if TYPE_CHECKING:
    ...
    from ..models.get_additional_seller_inputs_result import GetAdditionalSellerInputsResult


T = TypeVar("T", bound="GetAdditionalSellerInputsResponse")
...
class GetAdditionalSellerInputsResponse:
    ...
    Attributes:
        payload (Union[Unset, GetAdditionalSellerInputsResult]): The payload for the getAdditionalSellerInputs
            operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetAdditionalSellerInputsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetAdditionalSellerInputsResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetAdditionalSellerInputsResult.from_dict(_payload)
