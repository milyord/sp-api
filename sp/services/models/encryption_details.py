...
from ..models.encryption_details_standard import EncryptionDetailsStandard

T = TypeVar("T", bound="EncryptionDetails")
...
class EncryptionDetails:
    ...
    Attributes:
        standard (EncryptionDetailsStandard): The encryption standard required to encrypt or decrypt the document
            contents.
    ...
    standard: EncryptionDetailsStandard
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        standard = EncryptionDetailsStandard(d.pop("standard"))
