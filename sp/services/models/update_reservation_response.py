...
if TYPE_CHECKING:
    ...
    from ..models.update_reservation_record import UpdateReservationRecord


T = TypeVar("T", bound="UpdateReservationResponse")


@attr.s(auto_attribs=True)
class UpdateReservationResponse:
    r"""Response schema for the `updateReservation` operation.

    Attributes:
        payload (Union[Unset, UpdateReservationRecord]): `UpdateReservationRecord` entity contains the `Reservation` if
    ...
    payload: Union[Unset, "UpdateReservationRecord"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, UpdateReservationRecord]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = UpdateReservationRecord.from_dict(_payload)
