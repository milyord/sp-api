...
T = TypeVar("T", bound="GetServiceJobByServiceJobIdResponse")


@attr.s(auto_attribs=True)
class GetServiceJobByServiceJobIdResponse:
    r"""The response schema for the `getServiceJobByServiceJobId` operation.

    Attributes:
        payload (Union[Unset, ServiceJob]): The job details of a service.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ServiceJob"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ServiceJob]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ServiceJob.from_dict(_payload)
