...
if TYPE_CHECKING:
    from ..models.appointment_slot_report import AppointmentSlotReport
    from ..models.error import Error


T = TypeVar("T", bound="GetAppointmentSlotsResponse")


@attr.s(auto_attribs=True)
class GetAppointmentSlotsResponse:
    r"""The response of fetching appointment slots based on service context.

    Attributes:
        payload (Union[Unset, AppointmentSlotReport]): Availability information as per the service context queried.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "AppointmentSlotReport"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, AppointmentSlotReport]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = AppointmentSlotReport.from_dict(_payload)
