...
if TYPE_CHECKING:
    from ..models.create_reservation_record import CreateReservationRecord
    from ..models.error import Error


T = TypeVar("T", bound="CreateReservationResponse")


@attr.s(auto_attribs=True)
class CreateReservationResponse:
    r"""Response schema for the `createReservation` operation.

    Attributes:
        payload (Union[Unset, CreateReservationRecord]): `CreateReservationRecord` entity contains the `Reservation` if
            there is an error/warning while performing the requested operation on it, otherwise it will contain the new
            `reservationId`.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateReservationRecord"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, CreateReservationRecord]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = CreateReservationRecord.from_dict(_payload)
