...
T = TypeVar("T", bound="GetServiceJobsResponse")


@attr.s(auto_attribs=True)
class GetServiceJobsResponse:
    r"""Response schema for the `getServiceJobs` operation.

    Attributes:
        payload (Union[Unset, JobListing]): The payload for the `getServiceJobs` operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "JobListing"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, JobListing]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = JobListing.from_dict(_payload)
