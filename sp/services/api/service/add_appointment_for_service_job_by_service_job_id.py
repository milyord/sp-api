...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: AddAppointmentRequest,
) -> Dict[str, Any]:
    url = "{}/service/v1/serviceJobs/{serviceJobId}/appointments".format(client.base_url, serviceJobId=service_job_id)
...
def sync_detailed(
    ...
    **Usage Plan:**
    ...
    Args:
        service_job_id (str):
        json_body (AddAppointmentRequest): Input for add appointment operation.
