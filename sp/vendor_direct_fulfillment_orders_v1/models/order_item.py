...
if TYPE_CHECKING:
    ...
    from ..models.order_item_tax_details import OrderItemTaxDetails
...
class OrderItem:
    ...
    Attributes:
        ...
        tax_details (Union[Unset, OrderItemTaxDetails]): Total tax details for the line item.
    ...
    tax_details: Union[Unset, "OrderItemTaxDetails"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tax_details: Union[Unset, OrderItemTaxDetails]
        if isinstance(_tax_details, Unset):
            tax_details = UNSET
        else:
            tax_details = OrderItemTaxDetails.from_dict(_tax_details)
