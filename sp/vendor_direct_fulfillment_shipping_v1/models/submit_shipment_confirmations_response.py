...
T = TypeVar("T", bound="SubmitShipmentConfirmationsResponse")


@attr.s(auto_attribs=True)
class SubmitShipmentConfirmationsResponse:
    r"""The response schema for the submitShipmentConfirmations operation.

    Attributes:
        payload (Union[Unset, TransactionReference]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "TransactionReference"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = TransactionReference.from_dict(_payload)
