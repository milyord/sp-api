...
T = TypeVar("T", bound="GetCustomerInvoiceResponse")


@attr.s(auto_attribs=True)
class GetCustomerInvoiceResponse:
    r"""The response schema for the getCustomerInvoice operation.

    Attributes:
        payload (Union[Unset, CustomerInvoice]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CustomerInvoice"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CustomerInvoice.from_dict(_payload)
