...
T = TypeVar("T", bound="GetShippingLabelResponse")


@attr.s(auto_attribs=True)
class GetShippingLabelResponse:
    r"""The response schema for the getShippingLabel operation.

    Attributes:
        payload (Union[Unset, ShippingLabel]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ShippingLabel"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ShippingLabel.from_dict(_payload)
