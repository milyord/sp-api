...
T = TypeVar("T", bound="GetPackingSlipResponse")
...
class GetPackingSlipResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, PackingSlip]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = PackingSlip.from_dict(_payload)
