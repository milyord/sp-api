...
T = TypeVar("T", bound="GetShippingLabelListResponse")


@attr.s(auto_attribs=True)
class GetShippingLabelListResponse:
    r"""The response schema for the getShippingLabels operation.

    Attributes:
        payload (Union[Unset, ShippingLabelList]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ShippingLabelList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ShippingLabelList.from_dict(_payload)
