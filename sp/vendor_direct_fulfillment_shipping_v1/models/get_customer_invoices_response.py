...
T = TypeVar("T", bound="GetCustomerInvoicesResponse")


@attr.s(auto_attribs=True)
class GetCustomerInvoicesResponse:
    r"""The response schema for the getCustomerInvoices operation.

    Attributes:
        payload (Union[Unset, CustomerInvoiceList]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CustomerInvoiceList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CustomerInvoiceList.from_dict(_payload)
