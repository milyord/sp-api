...
T = TypeVar("T", bound="GetPackingSlipListResponse")
...
class GetPackingSlipListResponse:
    r"""
    Attributes:
        payload (Union[Unset, PackingSlipList]): A list of packing slips.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "PackingSlipList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, PackingSlipList]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = PackingSlipList.from_dict(_payload)
