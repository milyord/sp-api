...
from ...models.post_content_document_response import PostContentDocumentResponse
...
) -> Optional[Union[ErrorList, PostContentDocumentResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostContentDocumentResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorList, PostContentDocumentResponse]]:
    return Response(
