...
from ...models.list_content_document_asin_relations_included_data_set_item import (
    ListContentDocumentAsinRelationsIncludedDataSetItem,
)
from ...models.list_content_document_asin_relations_response import ListContentDocumentAsinRelationsResponse
...
def _get_kwargs(
    ...
    *,
    client: Client,
    marketplace_id: str,
    included_data_set: Union[Unset, None, List[ListContentDocumentAsinRelationsIncludedDataSetItem]] = UNSET,
    ...
    json_included_data_set: Union[Unset, None, List[str]] = UNSET
    if not isinstance(included_data_set, Unset):
        if included_data_set is None:
            json_included_data_set = None
        else:
...
) -> Optional[Union[ErrorList, ListContentDocumentAsinRelationsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListContentDocumentAsinRelationsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorList, ListContentDocumentAsinRelationsResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Returns a list of ASINs related to the specified A+ Content document, if available. If you do not
    include the asinSet parameter, the operation returns all ASINs related to the content document.
    ...
    **Usage Plans:**
    ...
    Args:
        content_reference_key (str):
        marketplace_id (str):
        included_data_set (Union[Unset, None,
            List[ListContentDocumentAsinRelationsIncludedDataSetItem]]):
