...
from ...models.post_content_document_asin_relations_request import PostContentDocumentAsinRelationsRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PostContentDocumentAsinRelationsRequest,
    marketplace_id: str,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Replaces all ASINs related to the specified A+ Content document, if available. This may add or
    remove ASINs, depending on the current set of related ASINs. Removing an ASIN has the side effect of
    suspending the content document from that ASIN.
