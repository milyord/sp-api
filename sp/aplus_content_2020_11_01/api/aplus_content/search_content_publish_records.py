...
from ...models.search_content_publish_records_response import SearchContentPublishRecordsResponse
...
def _get_kwargs(
    *,
    ...
    url = "{}/aplus/2020-11-01/contentPublishRecords".format(client.base_url)
...
) -> Optional[Union[ErrorList, SearchContentPublishRecordsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = SearchContentPublishRecordsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorList, SearchContentPublishRecordsResponse]]:
    return Response(
