...
from ...models.search_content_documents_response import SearchContentDocumentsResponse
...
def _get_kwargs(
    *,
    ...
    url = "{}/aplus/2020-11-01/contentDocuments".format(client.base_url)
...
) -> Optional[Union[ErrorList, SearchContentDocumentsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = SearchContentDocumentsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ErrorList, SearchContentDocumentsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Returns a list of all A+ Content documents assigned to a selling partner. This operation returns
    only the metadata of the A+ Content documents. Call the getContentDocument operation to get the
    actual contents of the A+ Content documents.
