...
T = TypeVar("T", bound="StandardFourImageTextModule")


@attr.s(auto_attribs=True)
class StandardFourImageTextModule:
    r"""Four standard images with text, presented across a single row.
    ...
    Attributes:
        ...
        block4 (Union[Unset, StandardImageTextBlock]): The A+ Content standard image and text box block.
    """
    ...
    block4: Union[Unset, "StandardImageTextBlock"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        block4: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.block4, Unset):
        ...
        if block4 is not UNSET:
            field_dict["block4"] = block4
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _block4 = d.pop("block4", UNSET)
        block4: Union[Unset, StandardImageTextBlock]
        if isinstance(_block4, Unset):
            block4 = UNSET
        else:
            block4 = StandardImageTextBlock.from_dict(_block4)
