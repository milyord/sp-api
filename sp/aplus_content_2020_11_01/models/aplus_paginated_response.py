...
T = TypeVar("T", bound="AplusPaginatedResponse")


@attr.s(auto_attribs=True)
class AplusPaginatedResponse:
    r"""The base response data for paginated A+ Content operations. Individual operations may extend this with additional
    data. If nextPageToken is not returned, there are no more pages to return.
