...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CreateFeedResponse, ErrorList]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CreateFeedResponse, ErrorList]]:
    return Response(
...
def sync_detailed(
    *,
    client: Client,
    json_body: CreateFeedSpecification,
) -> Response[Union[CreateFeedResponse, ErrorList]]:
    ...
    **Usage Plan:**
    ...
    Args:
        json_body (CreateFeedSpecification): Information required to create the feed.
...
def sync(
    *,
    client: Client,
    json_body: CreateFeedSpecification,
) -> Optional[Union[CreateFeedResponse, ErrorList]]:
    """Creates a feed. Upload the contents of the feed document before calling this operation.
