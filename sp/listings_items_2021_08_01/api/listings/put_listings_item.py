...
from ...models.listings_item_put_request import ListingsItemPutRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ListingsItemPutRequest,
...
def sync_detailed(
    ...
    **Usage Plan:**
    ...
    Args:
        ...
        json_body (ListingsItemPutRequest): The request body schema for the putListingsItem
            operation.
