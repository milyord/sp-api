...
class OrderDetails:
    ...
    Attributes:
        ...
        tax_total (Union[Unset, TaxItemDetails]): Total tax details for the line item.
    """
    ...
    tax_total: Union[Unset, "TaxItemDetails"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tax_total: Union[Unset, TaxItemDetails]
        if isinstance(_tax_total, Unset):
            tax_total = UNSET
        else:
            tax_total = TaxItemDetails.from_dict(_tax_total)
