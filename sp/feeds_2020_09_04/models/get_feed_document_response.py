...
T = TypeVar("T", bound="GetFeedDocumentResponse")
...
class GetFeedDocumentResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = FeedDocument.from_dict(_payload)
