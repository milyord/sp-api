...
if TYPE_CHECKING:
    from ..models.create_feed_document_result import CreateFeedDocumentResult
...
class CreateFeedDocumentResponse:
    r"""The response for the createFeedDocument operation.

    Attributes:
        payload (Union[Unset, CreateFeedDocumentResult]): Information required to encrypt and upload a feed document's
            contents.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateFeedDocumentResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, CreateFeedDocumentResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = CreateFeedDocumentResult.from_dict(_payload)
