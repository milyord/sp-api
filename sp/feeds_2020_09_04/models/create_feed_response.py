...
if TYPE_CHECKING:
    from ..models.create_feed_result import CreateFeedResult
    from ..models.error import Error


T = TypeVar("T", bound="CreateFeedResponse")
...
class CreateFeedResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CreateFeedResult.from_dict(_payload)
