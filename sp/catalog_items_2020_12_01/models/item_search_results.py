...
class ItemSearchResults:
    ...
    Attributes:
        number_of_results (int): The estimated total number of products matched by the search query (only results up to
            the page count limit will be returned per request regardless of the number found).
        ...
        pagination (Pagination): When a request produces a response that exceeds the pageSize, pagination occurs. This
            ...
            pass the nextToken value or the previousToken value as the pageToken parameter in the next request. When you
