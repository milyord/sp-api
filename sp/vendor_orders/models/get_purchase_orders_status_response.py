...
T = TypeVar("T", bound="GetPurchaseOrdersStatusResponse")


@attr.s(auto_attribs=True)
class GetPurchaseOrdersStatusResponse:
    r"""The response schema for the getPurchaseOrdersStatus operation.

    Attributes:
        payload (Union[Unset, OrderListStatus]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderListStatus"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = OrderListStatus.from_dict(_payload)
