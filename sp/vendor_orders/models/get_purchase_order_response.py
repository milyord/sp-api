...
T = TypeVar("T", bound="GetPurchaseOrderResponse")


@attr.s(auto_attribs=True)
class GetPurchaseOrderResponse:
    r"""The response schema for the getPurchaseOrder operation.

    Attributes:
        payload (Union[Unset, Order]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Order"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = Order.from_dict(_payload)
