...
T = TypeVar("T", bound="GetPurchaseOrdersResponse")


@attr.s(auto_attribs=True)
class GetPurchaseOrdersResponse:
    r"""The response schema for the getPurchaseOrders operation.

    Attributes:
        payload (Union[Unset, OrderList]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = OrderList.from_dict(_payload)
