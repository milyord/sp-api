...
T = TypeVar("T", bound="CreateConfirmCustomizationDetailsRequest")


@attr.s(auto_attribs=True)
class CreateConfirmCustomizationDetailsRequest:
    r"""The request schema for the confirmCustomizationDetails operation.

    Attributes:
        text (Union[Unset, str]): The text to be sent to the buyer. Only links related to customization details are
