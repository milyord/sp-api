...
T = TypeVar("T", bound="GetAuthorizationCodeResponse")


@attr.s(auto_attribs=True)
class GetAuthorizationCodeResponse:
    r"""The response schema for the GetAuthorizationCode operation.

    Attributes:
        payload (Union[Unset, AuthorizationCode]): A Login with Amazon (LWA) authorization code.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "AuthorizationCode"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, AuthorizationCode]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = AuthorizationCode.from_dict(_payload)
