...
if TYPE_CHECKING:
    ...
    from ..models.get_features_result import GetFeaturesResult
...
class GetFeaturesResponse:
    r"""The response schema for the getFeatures operation.

    Attributes:
        payload (Union[Unset, GetFeaturesResult]): The payload for the getFeatures operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetFeaturesResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetFeaturesResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetFeaturesResult.from_dict(_payload)
