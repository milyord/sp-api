...
if TYPE_CHECKING:
    ...
    from ..models.get_fulfillment_order_result import GetFulfillmentOrderResult


T = TypeVar("T", bound="GetFulfillmentOrderResponse")


@attr.s(auto_attribs=True)
class GetFulfillmentOrderResponse:
    r"""The response schema for the getFulfillmentOrder operation.

    Attributes:
        payload (Union[Unset, GetFulfillmentOrderResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetFulfillmentOrderResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetFulfillmentOrderResult.from_dict(_payload)
