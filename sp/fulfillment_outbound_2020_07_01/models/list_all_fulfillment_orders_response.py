...
if TYPE_CHECKING:
    ...
    from ..models.list_all_fulfillment_orders_result import ListAllFulfillmentOrdersResult


T = TypeVar("T", bound="ListAllFulfillmentOrdersResponse")


@attr.s(auto_attribs=True)
class ListAllFulfillmentOrdersResponse:
    r"""The response schema for the listAllFulfillmentOrders operation.

    Attributes:
        payload (Union[Unset, ListAllFulfillmentOrdersResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ListAllFulfillmentOrdersResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ListAllFulfillmentOrdersResult.from_dict(_payload)
