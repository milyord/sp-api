...
if TYPE_CHECKING:
    ...
    from ..models.get_fulfillment_preview_result import GetFulfillmentPreviewResult


T = TypeVar("T", bound="GetFulfillmentPreviewResponse")


@attr.s(auto_attribs=True)
class GetFulfillmentPreviewResponse:
    r"""The response schema for the getFulfillmentPreview operation.

    Attributes:
        payload (Union[Unset, GetFulfillmentPreviewResult]): A list of fulfillment order previews, including estimated
            shipping weights, estimated shipping fees, and estimated ship dates and arrival dates.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetFulfillmentPreviewResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetFulfillmentPreviewResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetFulfillmentPreviewResult.from_dict(_payload)
