...
if TYPE_CHECKING:
    ...
    from ..models.get_feature_inventory_result import GetFeatureInventoryResult


T = TypeVar("T", bound="GetFeatureInventoryResponse")


@attr.s(auto_attribs=True)
class GetFeatureInventoryResponse:
    r"""The breakdown of eligibility inventory by feature.

    Attributes:
        payload (Union[Unset, GetFeatureInventoryResult]): The payload for the getEligibileInventory operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetFeatureInventoryResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetFeatureInventoryResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetFeatureInventoryResult.from_dict(_payload)
