...
if TYPE_CHECKING:
    ...
    from ..models.get_feature_sku_result import GetFeatureSkuResult


T = TypeVar("T", bound="GetFeatureSkuResponse")


@attr.s(auto_attribs=True)
class GetFeatureSkuResponse:
    r"""The response schema for the getFeatureSKU operation.

    Attributes:
        payload (Union[Unset, GetFeatureSkuResult]): The payload for the getFeatureSKU operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetFeatureSkuResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetFeatureSkuResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetFeatureSkuResult.from_dict(_payload)
