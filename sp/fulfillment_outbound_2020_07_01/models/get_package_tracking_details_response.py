...
if TYPE_CHECKING:
    ...
    from ..models.package_tracking_details import PackageTrackingDetails


T = TypeVar("T", bound="GetPackageTrackingDetailsResponse")


@attr.s(auto_attribs=True)
class GetPackageTrackingDetailsResponse:
    r"""The response schema for the getPackageTrackingDetails operation.

    Attributes:
        payload (Union[Unset, PackageTrackingDetails]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "PackageTrackingDetails"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = PackageTrackingDetails.from_dict(_payload)
