...
if TYPE_CHECKING:
    ...
    from ..models.list_return_reason_codes_result import ListReturnReasonCodesResult


T = TypeVar("T", bound="ListReturnReasonCodesResponse")


@attr.s(auto_attribs=True)
class ListReturnReasonCodesResponse:
    r"""The response schema for the listReturnReasonCodes operation.

    Attributes:
        payload (Union[Unset, ListReturnReasonCodesResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ListReturnReasonCodesResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ListReturnReasonCodesResult.from_dict(_payload)
