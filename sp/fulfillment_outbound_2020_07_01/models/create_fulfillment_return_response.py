...
if TYPE_CHECKING:
    from ..models.create_fulfillment_return_result import CreateFulfillmentReturnResult
    from ..models.error import Error


T = TypeVar("T", bound="CreateFulfillmentReturnResponse")


@attr.s(auto_attribs=True)
class CreateFulfillmentReturnResponse:
    r"""The response schema for the createFulfillmentReturn operation.

    Attributes:
        payload (Union[Unset, CreateFulfillmentReturnResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateFulfillmentReturnResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CreateFulfillmentReturnResult.from_dict(_payload)
