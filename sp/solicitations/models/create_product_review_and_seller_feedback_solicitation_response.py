...
T = TypeVar("T", bound="CreateProductReviewAndSellerFeedbackSolicitationResponse")


@attr.s(auto_attribs=True)
class CreateProductReviewAndSellerFeedbackSolicitationResponse:
    r"""The response schema for the createProductReviewAndSellerFeedbackSolicitation operation.
