...
T = TypeVar("T", bound="CreateDestinationResponse")


@attr.s(auto_attribs=True)
class CreateDestinationResponse:
    r"""The response schema for the createDestination operation.

    Attributes:
        payload (Union[Unset, Destination]): Represents a destination created when you call the createDestination
            operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Destination"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, Destination]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = Destination.from_dict(_payload)
