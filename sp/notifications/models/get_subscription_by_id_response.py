...
T = TypeVar("T", bound="GetSubscriptionByIdResponse")


@attr.s(auto_attribs=True)
class GetSubscriptionByIdResponse:
    r"""The response schema for the getSubscriptionById operation.

    Attributes:
        payload (Union[Unset, Subscription]): Represents a subscription to receive notifications.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "Subscription"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, Subscription]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = Subscription.from_dict(_payload)
