...
T = TypeVar("T", bound="CouponPaymentEvent")


@attr.s(auto_attribs=True)
class CouponPaymentEvent:
    r"""An event related to coupon payments.

    Attributes:
        posted_date (Union[Unset, datetime.datetime]):
        coupon_id (Union[Unset, str]): A coupon identifier.
        seller_coupon_description (Union[Unset, str]): The description provided by the seller when they created the
            coupon.
        clip_or_redemption_count (Union[Unset, int]): The number of coupon clips or redemptions.
        payment_event_id (Union[Unset, str]): A payment event identifier.
    ...
    coupon_id: Union[Unset, str] = UNSET
    seller_coupon_description: Union[Unset, str] = UNSET
    clip_or_redemption_count: Union[Unset, int] = UNSET
    payment_event_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        seller_coupon_description = self.seller_coupon_description
        clip_or_redemption_count = self.clip_or_redemption_count
        ...
        if seller_coupon_description is not UNSET:
            field_dict["SellerCouponDescription"] = seller_coupon_description
        if clip_or_redemption_count is not UNSET:
            field_dict["ClipOrRedemptionCount"] = clip_or_redemption_count
        if payment_event_id is not UNSET:
            field_dict["PaymentEventId"] = payment_event_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        seller_coupon_description = d.pop("SellerCouponDescription", UNSET)

        clip_or_redemption_count = d.pop("ClipOrRedemptionCount", UNSET)

        payment_event_id = d.pop("PaymentEventId", UNSET)
