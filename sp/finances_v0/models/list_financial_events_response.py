...
if TYPE_CHECKING:
    ...
    from ..models.list_financial_events_payload import ListFinancialEventsPayload


T = TypeVar("T", bound="ListFinancialEventsResponse")


@attr.s(auto_attribs=True)
class ListFinancialEventsResponse:
    r"""The response schema for the listFinancialEvents operation.

    Attributes:
        payload (Union[Unset, ListFinancialEventsPayload]): The payload for the listFinancialEvents operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ListFinancialEventsPayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ListFinancialEventsPayload]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ListFinancialEventsPayload.from_dict(_payload)
