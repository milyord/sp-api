...
if TYPE_CHECKING:
    ...
    from ..models.list_financial_event_groups_payload import ListFinancialEventGroupsPayload


T = TypeVar("T", bound="ListFinancialEventGroupsResponse")


@attr.s(auto_attribs=True)
class ListFinancialEventGroupsResponse:
    r"""The response schema for the listFinancialEventGroups operation.

    Attributes:
        payload (Union[Unset, ListFinancialEventGroupsPayload]): The payload for the listFinancialEventGroups operation.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ListFinancialEventGroupsPayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, ListFinancialEventGroupsPayload]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = ListFinancialEventGroupsPayload.from_dict(_payload)
