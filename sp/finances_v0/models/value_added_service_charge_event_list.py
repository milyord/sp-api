...
T = TypeVar("T", bound="ValueAddedServiceChargeEventList")


@attr.s(auto_attribs=True)
class ValueAddedServiceChargeEventList:
    r"""An event related to a value added service charge.
    ...
    Attributes:
        ...
        description (Union[Unset, str]): A short description of the service charge event.
