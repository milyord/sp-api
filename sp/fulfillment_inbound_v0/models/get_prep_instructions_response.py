...
if TYPE_CHECKING:
    ...
    from ..models.get_prep_instructions_result import GetPrepInstructionsResult


T = TypeVar("T", bound="GetPrepInstructionsResponse")


@attr.s(auto_attribs=True)
class GetPrepInstructionsResponse:
    r"""The response schema for the getPrepInstructions operation.

    Attributes:
        payload (Union[Unset, GetPrepInstructionsResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetPrepInstructionsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetPrepInstructionsResult.from_dict(_payload)
