...
if TYPE_CHECKING:
    ...
    from ..models.get_shipments_result import GetShipmentsResult


T = TypeVar("T", bound="GetShipmentsResponse")


@attr.s(auto_attribs=True)
class GetShipmentsResponse:
    r"""The response schema for the getShipments operation.

    Attributes:
        payload (Union[Unset, GetShipmentsResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetShipmentsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetShipmentsResult.from_dict(_payload)
