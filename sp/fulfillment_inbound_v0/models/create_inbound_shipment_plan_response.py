...
if TYPE_CHECKING:
    from ..models.create_inbound_shipment_plan_result import CreateInboundShipmentPlanResult
    from ..models.error import Error


T = TypeVar("T", bound="CreateInboundShipmentPlanResponse")


@attr.s(auto_attribs=True)
class CreateInboundShipmentPlanResponse:
    r"""The response schema for the createInboundShipmentPlan operation.

    Attributes:
        payload (Union[Unset, CreateInboundShipmentPlanResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CreateInboundShipmentPlanResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CreateInboundShipmentPlanResult.from_dict(_payload)
