...
if TYPE_CHECKING:
    from ..models.bill_of_lading_download_url import BillOfLadingDownloadURL
    from ..models.error import Error


T = TypeVar("T", bound="GetBillOfLadingResponse")


@attr.s(auto_attribs=True)
class GetBillOfLadingResponse:
    r"""The response schema for the getBillOfLading operation.

    Attributes:
        payload (Union[Unset, BillOfLadingDownloadURL]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "BillOfLadingDownloadURL"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = BillOfLadingDownloadURL.from_dict(_payload)
