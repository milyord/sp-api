...
if TYPE_CHECKING:
    from ..models.confirm_preorder_result import ConfirmPreorderResult
    from ..models.error import Error


T = TypeVar("T", bound="ConfirmPreorderResponse")


@attr.s(auto_attribs=True)
class ConfirmPreorderResponse:
    r"""The response schema for the confirmPreorder operation.

    Attributes:
        payload (Union[Unset, ConfirmPreorderResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ConfirmPreorderResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ConfirmPreorderResult.from_dict(_payload)
