...
if TYPE_CHECKING:
    ...
    from ..models.label_download_url import LabelDownloadURL


T = TypeVar("T", bound="GetLabelsResponse")


@attr.s(auto_attribs=True)
class GetLabelsResponse:
    r"""The response schema for the getLabels operation.

    Attributes:
        payload (Union[Unset, LabelDownloadURL]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "LabelDownloadURL"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = LabelDownloadURL.from_dict(_payload)
