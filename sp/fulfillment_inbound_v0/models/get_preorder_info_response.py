...
if TYPE_CHECKING:
    ...
    from ..models.get_preorder_info_result import GetPreorderInfoResult


T = TypeVar("T", bound="GetPreorderInfoResponse")


@attr.s(auto_attribs=True)
class GetPreorderInfoResponse:
    r"""The response schema for the getPreorderInfo operation.

    Attributes:
        payload (Union[Unset, GetPreorderInfoResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetPreorderInfoResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetPreorderInfoResult.from_dict(_payload)
