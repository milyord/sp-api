...
T = TypeVar("T", bound="NonPartneredLtlDataOutput")


@attr.s(auto_attribs=True)
class NonPartneredLtlDataOutput:
    r"""Information returned by Amazon about a Less Than Truckload/Full Truckload (LTL/FTL) shipment shipped by a carrier
