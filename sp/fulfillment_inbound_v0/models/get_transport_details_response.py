...
if TYPE_CHECKING:
    ...
    from ..models.get_transport_details_result import GetTransportDetailsResult


T = TypeVar("T", bound="GetTransportDetailsResponse")


@attr.s(auto_attribs=True)
class GetTransportDetailsResponse:
    r"""The response schema for the getTransportDetails operation.

    Attributes:
        payload (Union[Unset, GetTransportDetailsResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetTransportDetailsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetTransportDetailsResult.from_dict(_payload)
