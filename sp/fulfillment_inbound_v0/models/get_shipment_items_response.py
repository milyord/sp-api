...
if TYPE_CHECKING:
    ...
    from ..models.get_shipment_items_result import GetShipmentItemsResult


T = TypeVar("T", bound="GetShipmentItemsResponse")


@attr.s(auto_attribs=True)
class GetShipmentItemsResponse:
    r"""The response schema for the getShipmentItems operation.

    Attributes:
        payload (Union[Unset, GetShipmentItemsResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetShipmentItemsResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetShipmentItemsResult.from_dict(_payload)
