...
if TYPE_CHECKING:
    ...
    from ..models.inbound_shipment_result import InboundShipmentResult


T = TypeVar("T", bound="InboundShipmentResponse")


@attr.s(auto_attribs=True)
class InboundShipmentResponse:
    r"""The response schema for this operation.

    Attributes:
        payload (Union[Unset, InboundShipmentResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "InboundShipmentResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = InboundShipmentResult.from_dict(_payload)
