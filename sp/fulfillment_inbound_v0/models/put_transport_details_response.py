...
if TYPE_CHECKING:
    from ..models.common_transport_result import CommonTransportResult
    from ..models.error import Error


T = TypeVar("T", bound="PutTransportDetailsResponse")


@attr.s(auto_attribs=True)
class PutTransportDetailsResponse:
    r"""Workflow status for a shipment with an Amazon-partnered carrier.

    Attributes:
        payload (Union[Unset, CommonTransportResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "CommonTransportResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = CommonTransportResult.from_dict(_payload)
