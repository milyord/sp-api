...
if TYPE_CHECKING:
    ...
    from ..models.get_inbound_guidance_result import GetInboundGuidanceResult


T = TypeVar("T", bound="GetInboundGuidanceResponse")


@attr.s(auto_attribs=True)
class GetInboundGuidanceResponse:
    r"""The response schema for the getInboundGuidance operation.

    Attributes:
        payload (Union[Unset, GetInboundGuidanceResult]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetInboundGuidanceResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = GetInboundGuidanceResult.from_dict(_payload)
