...
if TYPE_CHECKING:
    ...
    from ..models.list_matching_items_response import ListMatchingItemsResponse


T = TypeVar("T", bound="ListCatalogItemsResponse")
...
class ListCatalogItemsResponse:
    r"""
    Attributes:
        payload (Union[Unset, ListMatchingItemsResponse]):
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "ListMatchingItemsResponse"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = ListMatchingItemsResponse.from_dict(_payload)
