...
T = TypeVar("T", bound="ListCatalogCategoriesResponse")
...
class ListCatalogCategoriesResponse:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.payload, Unset):
            payload = []
            for componentsschemas_list_of_categories_item_data in self.payload:
                componentsschemas_list_of_categories_item = componentsschemas_list_of_categories_item_data.to_dict()

                payload.append(componentsschemas_list_of_categories_item)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for componentsschemas_list_of_categories_item_data in _payload or []:
            componentsschemas_list_of_categories_item = Categories.from_dict(
                componentsschemas_list_of_categories_item_data
            )
