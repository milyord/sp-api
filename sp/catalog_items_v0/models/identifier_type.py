...
class IdentifierType:
    r"""
    Attributes:
        marketplace_asin (Union[Unset, ASINIdentifier]):
        sku_identifier (Union[Unset, SellerSKUIdentifier]):
    """

    marketplace_asin: Union[Unset, "ASINIdentifier"] = UNSET
    sku_identifier: Union[Unset, "SellerSKUIdentifier"] = UNSET
    additional_properties: Dict[str, Any] = attr.ib(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        marketplace_asin: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.marketplace_asin, Unset):
        ...
        field_dict.update({})
        if marketplace_asin is not UNSET:
            field_dict["MarketplaceASIN"] = marketplace_asin
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _marketplace_asin = d.pop("MarketplaceASIN", UNSET)
        marketplace_asin: Union[Unset, ASINIdentifier]
        if isinstance(_marketplace_asin, Unset):
            marketplace_asin = UNSET
        else:
            marketplace_asin = ASINIdentifier.from_dict(_marketplace_asin)
