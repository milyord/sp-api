...
T = TypeVar("T", bound="GetCatalogItemResponse")
...
class GetCatalogItemResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, Item]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = Item.from_dict(_payload)
