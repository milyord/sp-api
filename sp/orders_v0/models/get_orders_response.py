...
if TYPE_CHECKING:
    ...
    from ..models.orders_list import OrdersList
...
class GetOrdersResponse:
    r"""The response schema for the getOrders operation.

    Attributes:
        payload (Union[Unset, OrdersList]): A list of orders along with additional information to make subsequent API
            calls.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrdersList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrdersList]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrdersList.from_dict(_payload)
