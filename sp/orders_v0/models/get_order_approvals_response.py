...
if TYPE_CHECKING:
    ...
    from ..models.order_approvals_response import OrderApprovalsResponse


T = TypeVar("T", bound="GetOrderApprovalsResponse")


@attr.s(auto_attribs=True)
class GetOrderApprovalsResponse:
    r"""The response schema for the getOrderApprovalsItems operation.

    Attributes:
        payload (Union[Unset, OrderApprovalsResponse]): The order items list with approvals along with the order ID.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderApprovalsResponse"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderApprovalsResponse]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderApprovalsResponse.from_dict(_payload)
