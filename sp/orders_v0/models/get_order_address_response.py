...
T = TypeVar("T", bound="GetOrderAddressResponse")


@attr.s(auto_attribs=True)
class GetOrderAddressResponse:
    r"""The response schema for the getOrderAddress operation.

    Attributes:
        payload (Union[Unset, OrderAddress]): The shipping address for the order.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderAddress]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderAddress.from_dict(_payload)
