...
if TYPE_CHECKING:
    ...
    from ..models.order_buyer_info import OrderBuyerInfo


T = TypeVar("T", bound="GetOrderBuyerInfoResponse")


@attr.s(auto_attribs=True)
class GetOrderBuyerInfoResponse:
    r"""The response schema for the getOrderBuyerInfo operation.

    Attributes:
        payload (Union[Unset, OrderBuyerInfo]): Buyer information for an order.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderBuyerInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderBuyerInfo]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderBuyerInfo.from_dict(_payload)
