...
if TYPE_CHECKING:
    ...
    from ..models.order_items_buyer_info_list import OrderItemsBuyerInfoList


T = TypeVar("T", bound="GetOrderItemsBuyerInfoResponse")


@attr.s(auto_attribs=True)
class GetOrderItemsBuyerInfoResponse:
    r"""The response schema for the getOrderItemsBuyerInfo operation.

    Attributes:
        payload (Union[Unset, OrderItemsBuyerInfoList]): A single order item's buyer information list with the order ID.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderItemsBuyerInfoList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderItemsBuyerInfoList]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderItemsBuyerInfoList.from_dict(_payload)
