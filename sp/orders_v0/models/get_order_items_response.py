...
if TYPE_CHECKING:
    ...
    from ..models.order_items_list import OrderItemsList


T = TypeVar("T", bound="GetOrderItemsResponse")


@attr.s(auto_attribs=True)
class GetOrderItemsResponse:
    r"""The response schema for the getOrderItems operation.

    Attributes:
        payload (Union[Unset, OrderItemsList]): The order items list along with the order ID.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderItemsList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderItemsList]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderItemsList.from_dict(_payload)
