...
if TYPE_CHECKING:
    ...
    from ..models.order_regulated_info import OrderRegulatedInfo


T = TypeVar("T", bound="GetOrderRegulatedInfoResponse")


@attr.s(auto_attribs=True)
class GetOrderRegulatedInfoResponse:
    r"""The response schema for the getOrderRegulatedInfo operation.

    Attributes:
        payload (Union[Unset, OrderRegulatedInfo]): The order's regulated information along with its verification
            status.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "OrderRegulatedInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, OrderRegulatedInfo]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = OrderRegulatedInfo.from_dict(_payload)
