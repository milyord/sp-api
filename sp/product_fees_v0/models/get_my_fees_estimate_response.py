...
if TYPE_CHECKING:
    ...
    from ..models.get_my_fees_estimate_result import GetMyFeesEstimateResult


T = TypeVar("T", bound="GetMyFeesEstimateResponse")
...
class GetMyFeesEstimateResponse:
    r"""
    Attributes:
        payload (Union[Unset, GetMyFeesEstimateResult]): Response schema.
        errors (Union[Unset, List['Error']]): A list of error responses returned when a request is unsuccessful.
    """

    payload: Union[Unset, "GetMyFeesEstimateResult"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GetMyFeesEstimateResult]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GetMyFeesEstimateResult.from_dict(_payload)
